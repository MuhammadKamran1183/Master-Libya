...
import com.mpressavicenna.app.databinding.FragmentSettingsBinding
import com.mpressavicenna.app.databinding.ItemAllProfilesBinding
import com.mpressavicenna.app.model.User
import com.mpressavicenna.app.ui.SplashActivity
...
import com.mpressavicenna.app.util.GeneralListener as GeneralListener1
            ...
            when (item) {
                ...
                getString(R.string.delete_account) -> {
                    requireActivity().displayPopUpOptions(
                        object : com.mpressavicenna.app.util.GeneralListener {
